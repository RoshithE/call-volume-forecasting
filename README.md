...
- **[Forecasting Copilot](https://github.com/RoshithE/forecasting-copilot)** - a Streamlit app that trains an ARIMA model on uploaded or synthetic call/demand data, evaluates forecast accuracy, projects future volume, estimates staffing needs, and uses the Claude API to generate a plain-language executive summary.
